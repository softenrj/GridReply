...
function Organizer() {
    ...
    return (
        <div className="h-fit w-full mx-auto my-6 p-6 sm:p-8 bg-white rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 font-sans">
            ...
            <div className="space-y-8">
                ...
                <div className="space-y-6">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                        <h3 className="text-lg font-bold text-gray-800">Editors</h3>
                                ...
                                {Array.from({ length: 4 }).map((_, index) => (
                                    ...
                                    >
                                        <input
                                            type="radio"
                                            name="mcq-answer"
                                            className="w-5 h-5 text-pink-500 border-gray-300 accent-pink-500 border-none cursor-pointer"
                                        />
